...
export function viewFactory_CalendarComponent0(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement):import1.AppView<import4.CalendarComponent> {
  if ((renderType_CalendarComponent === (null as any))) { (renderType_CalendarComponent = viewUtils.createRenderComponentType('/Users/twinssbc/WebstormProjects/Ionic2-Calendar/src/calendar.ts class CalendarComponent - inline template',0,import9.ViewEncapsulation.Emulated,styles_CalendarComponent,{})); }
